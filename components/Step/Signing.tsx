...
const Signing = ({
  ...
  return (
    <div className="flex flex-col">
      <div className="my-4">
        Farcaster Requires you to sign a message to verify ownership of your
        FID, please connect your Farcaster Recovery Address.
      </div>
      {isConnected ? (
        <>
      ...
      <div className="my-2">
        ...
        <p className="text-sm text-muted-foreground">
          This will be shown once, please back it up carefully. Click on the
          Textarea to copy.
        </p>
      </div>
      <div className="flex justify-center items-center my-6 gap-4">
        ...
        <Button disabled={!isConnected || loading} onClick={initRecovery}>
          {isConnected
            ? loading
              ? "Casting spells to speed up recovery"
              : "Initiate Recovery"
            : "Connect Wallet"}
        </Button>
      </div>
